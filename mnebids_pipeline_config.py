...
bids_root: PathLike | None = "/home/gercek/scratch/syntax_im/syntax_dataset/"
"""
...
subjects_dir: PathLike | None = (
    "/home/gercek/scratch/syntax_im/syntax_dataset/derivatives/freesurfer"
)
"""
...
ch_types: Annotated[Sequence[Literal["meg", "mag", "grad", "eeg"]], Len(1, 4)] = ["mag", "grad"]
"""
...
analyze_channels: Literal["all", "ch_types"] | Annotated[Sequence["str"], MinLen(1)] = "ch_types"
"""
...
raw_resample_sfreq: float | None = 500.22
"""
...
conditions: Sequence[str] | dict[str, str] | None = [
    *[
        "/".join(("TWOWORD", cond, freq))
        for cond in ["PHRASE", "NONPHRASE", "NONWORD"]
        for freq in ["F1LEFT", "F1RIGHT"]
    ],
    *["/".join(("ONEWORD", cond, freq)) for cond in ["WORD", "NONWORD"] for freq in ["F1", "F2"]],
]
"""
...
ica_algorithm: Literal["picard", "fastica", "extended_infomax", "picard-extended_infomax"] = (
    "picard"
)
"""
...
reject: dict[str, float] | Literal["autoreject_global", "autoreject_local"] | None = None
"""
...
decoding_which_epochs: Literal["uncleaned", "after_ica", "after_ssp", "cleaned"] = "cleaned"
"""
...
time_frequency_freq_min: float | None = 1.
"""
...
time_frequency_cycles: float | FloatArrayLike | None = np.arange(time_frequency_freq_min, time_frequency_freq_max) / 4
"""
...
time_frequency_baseline: tuple[float, float] | None = (-0.1999, 0)
"""
...
time_frequency_baseline_mode: str = "zscore"
"""
...
time_frequency_crop: dict | None = dict(tmin=0., tmax=2., fmin=15., fmax=22.)
"""
...
interpolate_bads_grand_average: bool = False
"""
...
memory_location: PathLike | bool | None = "/tmp/"
"""
...
on_error: Literal["continue", "abort", "debug"] = "continue"
"""
